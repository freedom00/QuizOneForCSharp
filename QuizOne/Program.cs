...
namespace QuizOne
{
    internal class Program
    {
        ...
        private delegate void StudentHandler();

        private static event StudentHandler StudentGraduated;
        ...
        private static void doRegister() => RegisterStudentOperation.Graduated();
        ...
        private static void Main(string[] args)
        {
            ...
            //#8
            StudentGraduated += new StudentHandler(doRegister);
            Student student = new Student() { Name = "Zhaosheng", Isgraduated = true };
